...
namespace PlakaKayitUygulamasi
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // Kullanýmý için formunuza þu þekilde ekleyebilirsiniz:
            // ToolbarControl nesnesini oluþtur
            // ToolbarControl nesnesini oluþtur ve formun üstüne ekle
            var toolbar = new ToolbarControl();

            // Ana formdaki mevcut metotlarý event'lere baðla
            toolbar.SaveClicked += SaveData;
            toolbar.UpdateClicked += UpdateData;
            toolbar.DeleteClicked += DeleteData;
        ...
        private void SaveData(object sender, EventArgs e)
        {
            ...
            // Kaydetme iþlemleriniz burada gerçekleþecek.
        }

        private void UpdateData(object sender, EventArgs e)
        {
            MessageBox.Show("Veri güncellendi!");
            // Güncelleme iþlemleriniz burada olacak.
        }

        private void DeleteData(object sender, EventArgs e)
        {
            MessageBox.Show("Veri silindi!");
            // Silme iþlemleriniz burada olacak.
        }
